...
const SSAARenderPass = function (scene, camera, clearColor, clearAlpha) {
  ...
  this.sampleLevel = 2 // specified as n, where the number of samples is 2^n, so sampleLevel = 4, is 2^4 samples, 16.
  this.unbiased = true
...
export {EffectComposer, ShaderPass, RenderPass, UnrealBloomPass, SMAAPass, SSAARenderPass}
